...
async function controlRecipes() {
    try {
        ...
        (0, _resultViewJsDefault.default).update(_modelJs.getSearchResultsPerPage());
        ...
        console.log(`${error} \u{1F4A5}\u{1F4A5}\u{1F4A5}`);
...
async function controlSearchResults() {
    try {
        ...
        (0, _resultViewJsDefault.default).render(_modelJs.getSearchResultsPerPage());
...
function controlPagination(goToPage) {
    ...
    (0, _resultViewJsDefault.default).render(_modelJs.getSearchResultsPerPage(goToPage));
...
async function controlAddRecipe(newRecipe) {
    try {
        ...
        console.error(`${error.message} \u{1F922}\u{1F92E}`);
        (0, _addRecipeViewJsDefault.default).renderError(`${error.message}`);
    }
}
(function() {
    (0, _bookmarkViewJsDefault.default).addHandlerRender(renderLoadedBookmarks);
    (0, _recipeViewsJsDefault.default).addHandler(controlRecipes);
    (0, _searchViewJsDefault.default).addHandler(controlSearchResults);
    (0, _paginationViewJsDefault.default).addHandlerClick(controlPagination.bind(this));
    (0, _recipeViewsJsDefault.default).addHandlerUpdateServings(controlServings.bind(this));
    (0, _recipeViewsJsDefault.default).addHandlerBookmark(controlBookmark);
    (0, _addRecipeViewJsDefault.default).addUploadRecipeHandler(controlAddRecipe);
})();

},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime":"dXNgZ","./model.js":"Y4A21","regenerator-runtime/runtime":"dXNgZ","./views/recipeViews.js":"fR5Tr","./views/searchView.js":"9OQAM","./views/resultView.js":"f70O5","./views/paginationView.js":"6z7bi","./views/bookmarkView.js":"7YaI3","./views/addRecipeView.js":"i6DNj","./config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
function getSearchResultsPerPage(page = state.search.page) {
...
const KEY = "f4bfe8ac-064f-4a64-9ac2-01929109226d";
...
async function AJAX(url, newRecipe) {
    try {
...
},{"regenerator-runtime":"dXNgZ","./config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fR5Tr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    _errorMessage = `The recipe you mentioned was not found. Please try again!`;
    addHandler(handler) {
        [
            "hashchange",
            "load"
    ...
    addHandlerUpdateServings(handler) {
        this._parentElement.addEventListener("click", function(e) {
            ...
            if (!btn) return;
            const updateServings = Number(btn.dataset.update);
...
},{"fracty":"hJO4d","../../img/icons.svg":"cMpiy","./view":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hJO4d":[function(require,module,exports) {
...
class View {
    _data;
    render(data, isRendering = true) {
        if (!data || Array.isArray(data) && data.length === 0) return this.renderError();
        this._data = data;
        const markup = this._generateMarkup();
        if (!isRendering) return markup;
        this._clear();
...
var _iconsSvg = require("../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _previewVew = require("./previewVew");
var _previewVewDefault = parcelHelpers.interopDefault(_previewVew);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
class ResultView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        return this._data.map((result)=>(0, _previewVewDefault.default).render(result, false)).join("");
    }
}
exports.default = new ResultView();

},{"../../img/icons.svg":"cMpiy","./previewVew":"jU7zd","./view":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jU7zd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (this._currentPage === 1 && numPages > 1) return `${this._generateCommonMarkup("next")}`;
        // Last page
        if (numPages === this._currentPage && numPages > 1) return `${this._generateCommonMarkup("prev")}`;
        // Middle Pages
        if (this._currentPage < numPages) return `${this._generateCommonMarkup("next")}${this._generateCommonMarkup("prev")}`;
        return " ";
    }
    _generateCommonMarkup(direction) {
        ...
        <button class="btn--inline pagination__btn--${direction}" data-page="${direction === "next" ? this._currentPage + 1 : this._currentPage - 1}">
            ${direction === "next" ? `<span>Page ${this._currentPage + 1}</span>
            <svg class="search__icon">
                <use href="${0, _iconsSvgDefault.default}#icon-arrow-right"></use>
...
},{"./view.js":"bWlJ9","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7YaI3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class BookmarkView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        return this._data.map((bookmark)=>(0, _previewVewDefault.default).render(bookmark, false)).join("");
    }
}
exports.default = new BookmarkView();

},{"../../img/icons.svg":"cMpiy","./previewVew":"jU7zd","./view":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i6DNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class AddRecipeView extends (0, _viewJsDefault.default) {
    ...
    addUploadRecipeHandler(handler) {
        this._parentElement.addEventListener("submit", function(e) {
            ...
            const dataArr = [
                ...new FormData(this)
            ]; // Returns a 2-D array => [[inputName, inputValue], [inputName, inputValue], ...];
...
},{"./view.js":"bWlJ9","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kYpTN","aenu9"], "aenu9", "parcelRequire95be")
